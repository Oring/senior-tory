<?php if ( ! defined( 'HT_THEME' ) ) exit( 'No direct script access allowed' );
/**
    ...
    //echo '<form method="post" id="import-data-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          //edit if ( OT_SHOW_SETTINGS_IMPORT ) echo '<p>' . __( 'Only after you\'ve imported the Settings should you try and update your Theme Options.', 'option-tree' ) . '</p>';
          
          //edit echo '<p>' . __( 'To import your Theme Options copy and paste what appears to be a random string of alpha numeric characters into this textarea and press the "Import Theme Options" button.', 'option-tree' ) . '</p>';
  ...
  function ot_type_export_data() {
    ...
    echo '<div class="format-setting type-textarea simple has-desc">';
      ...
      echo '<div class="description">';
       ...
       //edit echo '<p>' . __( 'Export your Theme Options data by highlighting this text and doing a copy/paste into a blank .txt file. Then save the file for importing into another install of WordPress later. Alternatively, you could just paste it into the <code>OptionTree->Settings->Import</code> <strong>Theme Options</strong> textarea on another web site.', 'option-tree' ) . '</p>';
